...
export default function NewsletterWelcome(): JSX.Element {
  const previewText = `Hello and welcome to ${siteConfig.name}`;

  return (
    <Html>
      <Head>
        <title>{`${siteConfig.name} Newsletter`}</title>
      </Head>
          ...
          <Container className="mx-auto my-[40px] max-w-2xl rounded p-4">
            ...
            <Section className="mt-4 text-center text-zinc-400">
              ...
              <Text className="mb-0 mt-4">
                @ {`${siteConfig.name}`}.com {new Date().getFullYear()}
              </Text>
            </Section>
          </Container>
        </Body>
...
//   const env = {
//     RESEND_EMAIL_FROM: 'mahmoudguedoul0@gmail.com',
//   };
//   const previewText = `Hello and welcome to ${siteConfig.name}`;
